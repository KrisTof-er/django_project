        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_type', models.CharField(
                    choices=[('PHONE_NUMBER', 'Phone Number'), ('EMAIL_ADDRESS', 'Email Address'),
                             ('TELEGRAM_NICKNAME', 'Telegram Nickname'), ('LINKEDIN_ID', 'LinkedIn ID')],
                    default='PHONE_NUMBER', max_length=30, verbose_name='Contact type')),
